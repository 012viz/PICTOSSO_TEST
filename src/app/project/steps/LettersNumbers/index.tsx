...
const LettersNumbers = (props: { preSelectedIcon?: IIcon, onIconPicked: (icon: IIcon) => void }) => {
    ...
    return (
        <div className="px-12 pb-48 flex flex-col h-full overflow-auto">
            ...
            <p className="text-xl font-bold text-center md:text-left text-black py-4 pt-0 md:py-12 ">Select Letter or Number</p>

            <div className="flex  flex-wrap gap-2 p-[1px] justify-between">
                {iconLetters.map((icon, index) => (
                    <RenderPicto
                        key={index}
                        showName={false}
                        onClick={() => {
